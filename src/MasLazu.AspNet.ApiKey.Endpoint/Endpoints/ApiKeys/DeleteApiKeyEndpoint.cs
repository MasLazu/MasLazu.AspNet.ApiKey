...
public class DeleteApiKeyEndpoint : BaseEndpointWithoutResponse<IdRequest>
{
    ...
    public override async Task HandleAsync(IdRequest request, CancellationToken ct)
    {
        ...
        await ApiKeyService.DeleteAsync(userId, request.Id, ct);
        await SendOkResponseAsync("Api key deleted successfully", ct);
    }
}
